...
CREATE TABLE IF NOT EXISTS consult_orders (
    ...
    paid_at TIMESTAMP WITH TIME ZONE,
    wecom_paid_notification_status VARCHAR(20),
    wecom_paid_notification_attempts INTEGER NOT NULL DEFAULT 0,
    wecom_paid_notification_last_error TEXT,
    wecom_paid_notified_at TIMESTAMP WITH TIME ZONE,
