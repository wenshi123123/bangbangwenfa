...
const consultServices: ServiceType[] = [
  { 
    ...
    icon: '💬',
    price: '必选',
    description: '面对刑事风险，律师比ai更能看清前路，含基础/标准/深度三个档位',
    isConsult: true,
    badge: '必选',
  },
];
...
const delegateServices: ServiceType[] = [
  { 
    ...
    icon: '🤝',
    price: '待评估',
    description: '隔着高墙，把家人的牵挂与法律帮助带给他',
    isConsult: false,
    badge: '可选',
  },
  { 
    ...
    icon: '⚖️',
    price: '待评估',
    description: '法庭之上，为当事人争取最轻的处理结果',
    isConsult: false,
    badge: '可选',
  },
  { 
    ...
    icon: '🛡️',
    price: '待评估',
    description: '从侦查到判决，全流程替你扛下刑事案件所有压力',
    isConsult: false,
    badge: '可选',
  },
];
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="flex gap-2 sm:gap-3">
        <button
          onClick={onBack}
          className="flex-1 py-2.5 sm:py-3 md:py-4 rounded-lg sm:rounded-xl md:rounded-xl font-semibold text-xs sm:text-sm md:text-base border-2 border-border bg-card hover:bg-muted transition-all duration-300"
        >
          上一步
        </button>
        <button
