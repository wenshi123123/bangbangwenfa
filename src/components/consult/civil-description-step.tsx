    ...
    <div className="animate-fade-in">
      ...
      <div className="text-center mb-6 sm:mb-8">
        <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-blue-50 border border-blue-100 mb-3 sm:mb-4">
          <span className="text-xs sm:text-sm font-medium text-blue-700">Step 2 / 4</span>
        </div>
      ...
      {onContactPhoneChange && (
        <div className="mb-4 sm:mb-6">
          ...
          <div className={`
            ...
            ${phoneFocused ? 'border-blue-400 shadow-lg shadow-blue-100' : 'border-border'}
      ...
      <div className="mb-4 sm:mb-6">
        <div className={`
          relative rounded-xl sm:rounded-2xl border-2 transition-all duration-300 overflow-hidden
          ${isFocused ? 'border-blue-400 shadow-lg shadow-blue-100' : 'border-border'}
        `}>
          <textarea
            value={value}
        ...
        <div className="flex justify-between items-center mt-2 sm:mt-3 px-1">
          <div className={`
            ...
            ${charCount < minChars ? 'text-muted-foreground' : 'text-blue-500'}
          `}>
            {charCount < minChars ? (
              <span>请填写案情描述</span>
            ) : (
