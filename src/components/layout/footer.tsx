        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12 max-w-6xl mx-auto">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex flex-col items-center sm:items-start">
              <div className="w-32 h-32 sm:w-36 sm:h-36 rounded-xl overflow-hidden border-4 border-orange-100 shadow-lg">
                <Image
                  src="/wechat-qr.png"
                  alt="扫码关注帮帮问法"
                  width={144}
              ...
              <p className="mt-1 text-xs sm:text-sm text-gray-500 leading-relaxed max-w-[240px] text-center sm:text-left">
              ...
              <ul className="space-y-2 sm:space-y-3">
                {links.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-xs sm:text-sm text-gray-500 hover:text-orange-500 transition-colors duration-200"
                    >
                      {link.label}
                    </Link>
                  </li>
